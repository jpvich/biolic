...
const COMMANDS: &[(&str, &str)] = &[
    ...
    ("filter", "Filter reads (not yet implemented)"),
    ("convert", "Convert between formats (not yet implemented)"),
    ("sample", "Subsample reads (not yet implemented)"),
    ("grep", "Search for patterns (not yet implemented)"),
    ("head", "Extract first N reads (not yet implemented)"),
    ("tail", "Extract last N reads (not yet implemented)"),
...
fn flags_for(command: &str) -> &'static [(&'static str, &'static str)] {
    match command {
        ...
        "filter" => &[
            ...
            ("--headcrop", "Trim bases from start"),
            ("--tailcrop", "Trim bases from end"),
            ("--help", "Show help"),
        ],
